...
export default async function EquipmentPage({ searchParams }: { searchParams: SearchParams }) {
  ...
  return (
    <>
      ...
      {raw.returned && <div className="alert success">Equipamento devolvido à locadora e preservado no histórico.</div>}
      <section className="panel">
        ...
        {result.data.length === 0 ? <EmptyState /> : <div className="data-table-wrap"><table className="data-table">
          <thead><tr><th>Equipamento</th><th>Patrimônio</th><th>Propriedade</th><th>Categoria</th><th>Equipe atual</th><th>Status</th><th></th></tr></thead>
