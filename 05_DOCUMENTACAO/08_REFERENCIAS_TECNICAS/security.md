...
3. Execute `deno check --config 04_BANCO_E_SUPABASE/supabase/functions/create-employee/deno.json
   --no-lock 04_BANCO_E_SUPABASE/supabase/functions/create-employee/index.ts`.
