...
Atualização de 09/09/2026: consulte [Funções do Mobile incorporadas ao Web](../11_FUNCOES_MOBILE_NO_WEB.md) para os novos fluxos, testes e pendências. A matriz abaixo descreve a base anterior à ampliação.
...
| Movimentações | Materiais e patrimônios | Operação e relatórios históricos separados | Procedimentos de movimentação e correção administrativa; consulte as limitações de validação no relatório atualizado |
