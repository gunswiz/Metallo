                    ...
                    children: [
                      Container(
                        ...
                        child: Icon(step.icon,
                            color: const Color(0xFF52A9FF), size: 29),
                      ),
    ...
    return Scaffold(
      ...
      body: ListView(padding: const EdgeInsets.all(16), children: [
        ...
        for (final topic in visible)
          Card(
            child: ExpansionTile(
              leading: Icon(topic.icon, color: const Color(0xFF52A9FF)),
              ...
              children: [
                ...
                _tutorialInfo(Icons.check_circle_outline, 'Resultado',
                    topic.result, const Color(0xFF67D39A)),
...
class _CountChip extends StatelessWidget {
  ...
  Widget build(BuildContext context) =>
      Row(mainAxisSize: MainAxisSize.min, children: [
        Icon(icon, size: 15, color: const Color(0xFF52A9FF)),
